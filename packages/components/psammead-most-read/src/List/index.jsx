...
const MostReadList = ({ numberOfItems, dir, columnLayout, children }) => {
  const MostReadListGrid = columnLayout;
  return (
    <MostReadListGrid
      {...mostReadListGridProps(getColumnLayout(columnLayout))}
      dir={dir}
...
MostReadList.propTypes = {
  ...
  dir: oneOf(['rtl', 'ltr']),
  columnLayout: oneOf([OneColumnGrid, TwoColumnGrid, MultiColumnGrid]),
  numberOfItems: number.isRequired,
};

MostReadList.defaultProps = {
  dir: 'ltr',
  columnLayout: MultiColumnGrid,
};
